...
\textbf{Date:} & 31/10/2011 \\ %\hline
\textbf{Document code:} &  \\ %\hline 
\textbf{Document URL:} & \url{http://www.vamdc.org/documents/software/JavaNodeSwDoc_11.10.pdf} \\ %\hline 
...
\textbf{Abstract:} & 
This document is a guide for deployment and use of the Java VAMDC-TAP Node software implementation.
\end{tabular}
